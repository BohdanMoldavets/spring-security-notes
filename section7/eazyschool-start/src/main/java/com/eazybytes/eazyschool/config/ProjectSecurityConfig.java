...
public class ProjectSecurityConfig {
    ...
    @Autowired
    public ProjectSecurityConfig(CustomAuthenticationSuccessHandler customAuthenticationSuccessHandler, CustomAuthenticationFailureHandler customAuthenticationFailureHandler) {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .formLogin(form -> form.loginPage("/login")
                        .defaultSuccessUrl("/home").successHandler(customAuthenticationSuccessHandler)
